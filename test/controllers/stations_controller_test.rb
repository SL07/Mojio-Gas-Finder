...
class StationsControllerTest < ActionController::TestCase
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post :create, station: { address: @station.address, city: @station.city, lat: @station.lat, long: @station.long, name: @station.name, price: @station.price }
    end
  ...
  test "should update station" do
    patch :update, id: @station, station: { address: @station.address, city: @station.city, lat: @station.lat, long: @station.long, name: @station.name, price: @station.price }
    assert_redirected_to station_path(assigns(:station))
  end
